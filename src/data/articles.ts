...
export const articles = [
  {
    id: 1,
    title: "Illinois Passes $1.5 Billion Transit Funding Bill, Avoiding Fiscal Cliff",
    slug: "illinois-transit-funding-bill",
    description: "Illinois General Assembly passed a $1.5 billion transit funding overhaul bill saving CTA, Metra, and Pace from fiscal cliff. Establishes new oversight committees and generated funding without creating new taxes.",
    date: "Oct 31, 2025",
    datetime: "2025-10-31",
...
State rescue packages typically include technology modernization provisions. Illinois model emphasizes data-driven oversight, making this a buying window for predictive analytics, workforce management systems, and real-time operational monitoring platforms. Procurement timelines typically compress under legislative pressure—expect expedited RFPs Q1-Q2 2026.`,
  ...
  {
    id: 2,
    title: "MARTA Completes Fare Collection System Modernization",
    slug: "marta-fare-collection-modernization",
    description: "Atlanta's MARTA completed replacement of entire fare collection equipment by Spring 2026, including new Breeze cards, faregates, validators, fareboxes, vending machines, and mobile app.",
    date: "Oct 30, 2025",
    datetime: "2025-10-30",
...
Contactless payment integration is now baseline requirement, not competitive differentiator. Mobile-first passenger experience expectations from fare collection projects extend to paratransit self-service booking portals and real-time vehicle tracking interfaces.`,
  ...
  {
    id: 3,
    title: "Denver RTD Launches In-House Detective Bureau for Transit Crime",
    slug: "denver-rtd-detective-bureau",
    description: "Denver RTD Police Department launched detective bureau to investigate transit crimes in-house, covering 8 counties and 40 municipalities, reducing reliance on local police departments.",
    date: "Oct 17, 2025",
    datetime: "2025-10-17",
...
RTD's model represents growing trend toward transit-specific law enforcement requiring specialized technology stack distinct from municipal police systems. This creates opportunity for integrated safety platforms combining real-time monitoring, evidence management, and investigative tools purpose-built for transit operations.`,
  },
  {
    ...
    slug: "autocab-ztrip-partnership",
    description: "Landmark partnership between Autocab and zTrip powering 3,600 vehicles across 20 US states. Integration includes Uber & iGo platforms with NTEP-certified soft meter approved for U.S. use.",
    date: "Oct 28, 2025",
    datetime: "2025-10-28",
...
The taxi-to-TNC platform integration validates demand response software providers offering multi-system integration capabilities. Paratransit agencies increasingly require scheduling platforms integrating with: Medicaid transportation brokers, healthcare provider appointment systems, regional mobility hubs, and fixed-route transit real-time data. Single-platform vendors without integration capabilities face competitive disadvantage.`,
  ...
  {
    id: 5,
    title: "KCATA Launches Major Fare Payment System RFP",
    slug: "kcata-fare-payment-rfp",
    description: "Kansas City Area Transportation Authority issued RFP for complete fare payment system replacement, estimated $15-30M opportunity for fare collection technology vendors.",
    date: "Oct 21, 2025",
    datetime: "2025-10-21",
...
Response deadline typically allows 60-90 days. Prime vendor shortlist likely established through pre-RFP industry engagement. Incumbent vendor has relationship advantage but implementation risk concerns often drive competitive procurements.`,
  ...
  {
    id: 6,
    title: "Microtransit Expansion Accelerates in Municipal Markets",
    slug: "microtransit-municipal-expansion",
    description: "October 2025 showed significant microtransit expansion with new launches in Albuquerque, New Braunfels, Salisbury, Sugar Land, and Newport News. Mobile app interfaces becoming standard.",
    date: "Oct 15, 2025",
    datetime: "2025-10-15",
